...
Notes:
- If you're making changes to Dashy's codebase, you can run `yarn dev` to start the dev server with hot reloading. See the [Developing](/docs/developing) docs for more info.
